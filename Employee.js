...
export class Employee extends Component{
    ...
    changeDateOdJoining =(e)=>{
        this.setState({DateOdJoining:e.target.value});
    }
    ...
    editClick(emp){
        this.setState({
            ...
            DateOdJoining:emp.DateOdJoining,
    ...
    createClick(){
        fetch(variables.API_URL+'employee',{
            ...
            body:JSON.stringify({
                ...
                DateOdJoining:this.state.DateOdJoining,
    ...
    <div className="d-flex flex-row bd-highlight mb-3">
     ...
     <div className="p-2 w-50 bd-highlight">
        ...
        <div className="input-group mb-3">
            ...
            <input type="date" className="form-control"
            value={DateOdJoining}
            onChange={this.changeDateOdJoining}/>
        </div>
